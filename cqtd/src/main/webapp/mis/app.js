...
Ext.application({
    ...
    //views:['mainframe_Viewport'],//可以不写，默认去找的就是view/Viewport
    controllers:['MainFrameController'],
    launch:function(){
    	application = this;
        Ext.tip.QuickTipManager.init();
        this.controllers.addListener('add',this.newControllerAdded,this);
        if(!this.hasController('MainFrameController')){
           this.addController('MainFrameController');
		}
    }
 });
